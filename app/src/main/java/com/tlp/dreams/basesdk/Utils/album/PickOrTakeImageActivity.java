...
//        getAllImages();
        ...
        //计算每张图片应该显示的宽度
        perWidth = (((WindowManager) (GlobalApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth() - CommonUtil.dip2px(this, 4)) / 3;
...
//    }
    ...
    private class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (currentShowPosition == -1 && i == 0) {
                ...
                ((ImageView) view).setBackgroundResource(R.mipmap.take_pic);
    ...
    private void takePic() {
        ...
        tempPath = CommonUtil.getDataPath() + name + dataString + ".jpg";
